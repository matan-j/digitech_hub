...
import { LayoutDashboard, BookOpen, Compass, BookText, Users, Palette, Tags, Sparkles, UserSearch, Home, KeyRound } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/admin/access', label: 'גישות והזמנות', Icon: KeyRound, exact: false },
